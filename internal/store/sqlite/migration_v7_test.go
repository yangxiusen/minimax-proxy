...
func TestOpenMigratesEmptyDatabaseThroughLatestVersionAndIsRepeatable(t *testing.T) {
...
func TestOpenForwardsVersionSevenCallbackRowsThroughLatestVersion(t *testing.T) {
	ctx := context.Background()
