...
| 004-manager-node-configuration | 管理后台迁移与模型节点数据库配置 | 迭代 | Pending | 待人工填写 | CHANGE_SPEC.md、PRD_DELTA.md、TECH_SOLUTION.md、DATABASE_DELTA.md、API_DELTA.md、api-modules/manager-nodes.md、PROTOTYPE_DELTA.md、task.md、TEST_ACCEPTANCE.md | `specs/developing/version_0.0.1/changes/004-manager-node-configuration/` | 设计完成，待开发 |
